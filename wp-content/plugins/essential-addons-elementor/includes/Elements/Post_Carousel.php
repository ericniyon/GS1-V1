...
class Post_Carousel extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'two' => [
						'title' => esc_html__('Two', 'essential-addons-elementor'),
						'image' => $image_path . 'two.png'
					],
					'three' => [
						'title' => esc_html__('Three', 'essential-addons-elementor'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => __('Make sure to enable <strong>Show Date</strong> option from <strong>Layout Settings</strong>', 'essential-addons-elementor'),
				'content_classes' => 'eael-warning',
				'condition'       => [
