 ...
 * @return void
 */
function emerge_business_register_block_variation() {
	wp_enqueue_script(
		'emerge-business-block-variations',
...
add_action( 'enqueue_block_assets', 'emerge_business_register_block_variation' );
